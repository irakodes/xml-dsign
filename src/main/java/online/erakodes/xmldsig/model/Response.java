 ...
 * }</pre>
 *
 * <p>Note: The error field uses {@link Error} which has been extended
...
public class Response<T> {
     ...
     * <p>
     * Uses the extended {@link Error} class which supports both
    ...
    @Schema(
            description = "Error details (only present for error responses). " +
                    "Uses the Error structure which supports both RFC 7807 format " +
